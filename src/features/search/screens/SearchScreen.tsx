...
import { SearchField, SectionTitle } from "../../../shared/components";
...
export function SearchScreen({
  ...
  return (
    <View>
      <SearchField value={query} onChangeText={setQuery} placeholder="Rechercher un medicament" />
      <SearchField value={pharmacyQuery} onChangeText={setPharmacyQuery} placeholder="Chercher une pharmacie ou un quartier" />
